Boundary = {
  ...
  pageIncrement:  {},
  defaultCreateArgs: [
    'context', 'collection', 'selector', 'increment', 'template'
  ],
  ...
  create: function(args) {
    ...
    args.template.sub = args.template.sub ? args.template.sub : {};
    ...
    /*
      ...
      based on this
     */
    args.template.data.ready = args.template.sub.ready ? args.template.sub.ready() : false;
